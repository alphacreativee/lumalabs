...
function parallaxIt(e, t, o) {
  var t = $(t),
    r = e.pageX - t.offset().left,
    e = e.pageY - t.offset().top,
    r = (r / t.width() - 0.5) * o,
    e = (e / t.height() - 0.5) * o;
  TweenMax.to(t, 0.3, { x: r, y: e, ease: Power2.easeOut });
}
function callParallax(e) {
  var t = $(e.currentTarget),
    ...
    r = t.find("span");
  parallaxIt(e, t, 10),
    o.length && parallaxIt(e, o, 20),
    r.length && parallaxIt(e, r, 15);
}
function hoverIcon() {
  $(".list-item .item").mousemove(function (e) {
    ...
    $(".list-item .item").mouseenter(function (e) {
      TweenMax.to($(this).find("img"), 0.3, { scale: 0.9 });
    }),
    $(".btn-large").mouseleave(function (e) {
      TweenMax.to(this, 0.3, { x: 0, y: 0, ease: Power2.easeOut }),
