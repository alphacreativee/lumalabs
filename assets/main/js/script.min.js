...
function introduce() {
  gsap.registerPlugin(ScrollTrigger);
  let t = gsap.utils.toArray(".slide");
            ...
            t.forEach((e) => {
              ...
              var t =
                ((t = window
                  ...
                  ? parseFloat(t[1].split(", ")[14] || 0)
                  : 0) +
                (12500 * o) / 10;
              let r;
              (r =
                -2500 < t ? a(t, -2500, 0, 0.5, 1) : a(t, -5e3, -2500, 0, 0.5)),
                (e.style.opacity = Math.max(0, Math.min(1, r))),
                (e.style.transform = `translate3d(-50%, -50%, ${t}px)`);
            });
        },
      })
